...
Fees Manager is the only tool you need to collect and manage student fees. 
      </p>
      <div className="mt-10 flex justify-center space-x-6">
        <ButtonLink href="/register">Get 1 month free</ButtonLink>
        <ButtonLink
          href="https://www.youtube.com/watch?v=9PxL5w-nd_U"
          variant="outline"
        >
          <svg
            aria-hidden="true"
